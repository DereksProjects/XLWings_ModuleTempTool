...
class mapWaterVaporPressure:

    def outputMapWaterVaporPressure(path , mapSelect ):
        '''
        EXECUTION METHOD
        ...
        if mapSelect == 'waterVaporPressure':
            moduleType = 'Average of Yearly Water Vapor Pressure(kPa)'
            htmlString = '_yearly_water_vapor_pressure'
        ...
        output_file('Yearly_Water_Vapor_Pressure_Map(kpa)' + htmlString + '.html')     
        ...
        p.circle("Lon",
                 ...
                 fill_color = linear_cmap('selector', colorSelector, low=0, high=3.2),
                 line_color =None,  
        ...
        color_mapper = LinearColorMapper(palette= colorSelector, low=.1, high=3.2)
        ...
        ("Lat","@Latitude"),
        ("Lon","@Longitude"),
        ("Average Water Vapor Pressure","@selector" + " (kPa)"),
