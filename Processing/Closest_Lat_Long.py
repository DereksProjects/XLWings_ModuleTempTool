...
#                                                    ], axis=1)
    ...
    firstRow_summary_df['Distance(km)'] = latLong_df.apply(lambda x: distance(lat1, lon1, x['Site latitude'], x['Site longitude']) , axis=1)
...
def closestLocationFrame( currentDirectory ,  lat1 , lon1 ):
    ...
    firstRow_summary_df = calcDistanceFrame(currentDirectory ,  lat1 , lon1 )
